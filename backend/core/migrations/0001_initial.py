# Generated by Django 6.0.6 on 2026-06-22 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin/Manager'), ('trainer', 'Trainer'), ('student', 'Student')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_batch', models.ForeignKey(blank=True, help_text='Null means sent to all students', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='announcements', to='core.batch')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('license_status', models.CharField(choices=[('none', 'None (No License)'), ('learner', "Learner's License"), ('full', 'Full License'), ('expired', 'Expired License')], default='none', max_length=20)),
                ...
                ('preferred_batch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='core.batch')),
